...
export default function TeamCard({ name, role, bio, initials, color = 'bg-accent' }: TeamCardProps) {
  return (
    <div className="h-full border-3 border-border-light dark:border-border-dark p-8 glow-accent transition-[border-color,box-shadow] duration-200 hover:border-accent group">
