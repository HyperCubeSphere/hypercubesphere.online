...
export default function BlogCard({ slug, title, date, excerpt, category, readTime, locale }: BlogCardProps) {
  return (
    ...
    >
      ...
      <p className="text-[13px] text-muted-light dark:text-muted-dark leading-relaxed mb-3">{excerpt}</p>
