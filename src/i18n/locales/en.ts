const en = {
  ...
  services: {
    ...
    subtitle: 'Six core practice areas. One mission: engineer solutions that are strategic, secure, and built to last.',
  ...
  team: {
    ...
    seoDescription: 'Six specialists with decades of combined experience in AI, cybersecurity, cloud architecture, and enterprise software engineering.',
    eyebrow: '// Our Team',
    headingPre: 'The People Behind ',
    headingBold: 'The Code',
    subtitle: 'Six specialists. Decades of combined experience. One shared commitment to engineering excellence.',
    members: [
